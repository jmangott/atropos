...
./bin/hierarchical-cme -o apoptosis_pbn_r5_e_tau1e-2 -s 100 -t 0.01 -f 20.0 -m e

python3 scripts/input_generation/set_boolean_apoptosis.py -pb -r 10
./bin/hierarchical-cme -o apoptosis_pbn_r10_e_tau1e-2 -s 100 -t 0.01 -f 20.0 -m e

python3 scripts/input_generation/set_boolean_apoptosis.py -pb -r 20
./bin/hierarchical-cme -o apoptosis_pbn_r20_e_tau1e-2 -s 100 -t 0.01 -f 20.0 -m e


python3 scripts/input_generation/set_boolean_apoptosis.py -pr -r 5
./bin/hierarchical-cme -o apoptosis_prn_r5_e_tau1e-2 -s 100 -t 0.01 -f 20.0 -m e

python3 scripts/input_generation/set_boolean_apoptosis.py -pr -r 10
./bin/hierarchical-cme -o apoptosis_prn_r10_e_tau1e-2 -s 100 -t 0.01 -f 20.0 -m e

python3 scripts/input_generation/set_boolean_apoptosis.py -pr -r 20
./bin/hierarchical-cme -o apoptosis_prn_r20_e_tau1e-2 -s 100 -t 0.01 -f 20.0 -m e


python3 scripts/input_generation/set_boolean_apoptosis.py -pw -r 5
./bin/hierarchical-cme -o apoptosis_pwn_r5_e_tau1e-2 -s 100 -t 0.01 -f 20.0 -m e

python3 scripts/input_generation/set_boolean_apoptosis.py -pw -r 10
./bin/hierarchical-cme -o apoptosis_pwn_r10_e_tau1e-2 -s 100 -t 0.01 -f 20.0 -m e

python3 scripts/input_generation/set_boolean_apoptosis.py -pw -r 20
./bin/hierarchical-cme -o apoptosis_pwn_r20_e_tau1e-2 -s 100 -t 0.01 -f 20.0 -m e
