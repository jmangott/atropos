...
template<> vector<ind> APOPTOSIS::depends_on<0>() {
    return { 0 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<1>() {
    return { 1 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<2>() {
    return { 0,2 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<3>() {
    return { 2,3 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<4>() {
    return { 3,4 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<5>() {
    return { 3,5 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<6>() {
    return { 4,6 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<7>() {
    return { 0,7 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<8>() {
    return { 5,7,8 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<9>() {
    return { 8,9 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<10>() {
    return { 9,10,11,18 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<11>() {
    return { 11,23 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<12>() {
    return { 4,12 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<13>() {
    return { 12,13,18 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<14>() {
    return { 1,14 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<15>() {
    return { 14,15 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<16>() {
    return { 14,16 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<17>() {
    return { 15,16,17,37 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<18>() {
    return { 17,18 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<19>() {
    return { 18,19,35 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<20>() {
    return { 3,20 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<21>() {
    return { 6,20,21,31 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<22>() {
    return { 10,22,23 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<23>() {
    return { 22,23 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<24>() {
    return { 13,24 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<25>() {
    return { 21,25,28,39 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<26>() {
    return { 25,26 };
}
...
template<> bool APOPTOSIS::rule<30>(bitset<41> x) {
    return x[29];
}
template<> vector<ind> APOPTOSIS::depends_on<30>() {
    return { 29,30 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<31>() {
    return { 29,31,39 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<33>() {
    return { 23,33,34,35 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<34>() {
    return { 18,34,35 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<35>() {
    return { 19,24,35,40 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<36>() {
    return { 35,36 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<37>() {
    return { 35,37 };
}
...
template<> vector<ind> APOPTOSIS::depends_on<38>() {
    return { 32,33,38 };
}
...
template<> bool APOPTOSIS::rule<40>(bitset<41> x) {
    return x[29] && x[30];
}
template<> vector<ind> APOPTOSIS::depends_on<40>() {
    return { 29,30,40 };
}