...
template<> vector<ind> PANCREATICCANCER::depends_on<0>() {
    return { 0 };
}
...
template<> vector<ind> PANCREATICCANCER::depends_on<1>() {
    return { 0,1 };
}
...
template<> vector<ind> PANCREATICCANCER::depends_on<2>() {
    return { 0,2 };
}
...
template<> vector<ind> PANCREATICCANCER::depends_on<3>() {
    return { 1,3 };
}
...
template<> vector<ind> PANCREATICCANCER::depends_on<4>() {
    return { 2,4 };
}
...
template<> vector<ind> PANCREATICCANCER::depends_on<5>() {
    return { 3,5 };
}
...
template<> vector<ind> PANCREATICCANCER::depends_on<6>() {
    return { 3,6 };
}
...
template<> vector<ind> PANCREATICCANCER::depends_on<7>() {
    return { 4,7,14 };
}
...
template<> vector<ind> PANCREATICCANCER::depends_on<8>() {
    return { 7,8 };
}
...
template<> vector<ind> PANCREATICCANCER::depends_on<9>() {
    return { 4,5,9 };
}
...
template<> vector<ind> PANCREATICCANCER::depends_on<11>() {
    return { 10,11 };
}
...
template<> vector<ind> PANCREATICCANCER::depends_on<12>() {
    return { 6,12 };
}
...
template<> vector<ind> PANCREATICCANCER::depends_on<14>() {
    return { 13,14 };
}
...
template<> bool PANCREATICCANCER::rule<16>(bitset<34> x) {
    return x[16];
}
template<> vector<ind> PANCREATICCANCER::depends_on<16>() {
    return { 16 };
}
...
template<> vector<ind> PANCREATICCANCER::depends_on<19>() {
    return { 19,25 };
}
...
template<> vector<ind> PANCREATICCANCER::depends_on<21>() {
    return { 21,26 };
}
...
template<> vector<ind> PANCREATICCANCER::depends_on<25>() {
    return { 20,25 };
}
...
template<> vector<ind> PANCREATICCANCER::depends_on<26>() {
    return { 23,26 };
}
...
template<> vector<ind> PANCREATICCANCER::depends_on<27>() {
    return { 22,27 };
}
...
template<> vector<ind> PANCREATICCANCER::depends_on<28>() {
    return { 25,28 };
}
...
template<> vector<ind> PANCREATICCANCER::depends_on<29>() {
    return { 25,29 };
}
...
template<> vector<ind> PANCREATICCANCER::depends_on<33>() {
    return { 31,33 };
}
