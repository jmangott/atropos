...
TEST_CASE("s_step", "[s_step]")
{
    ...
    // {
        ...
        CalculateCoefficientsS(e_coeff0, f_coeff0, b_coeff_vec_shift0, b_coeff_vec0, lr_sol, blas, test_system, grid, partition1, 0, sigma1);
        CalculateCoefficientsS(e_coeff1, f_coeff1, b_coeff_vec_shift1, b_coeff_vec1, lr_sol, blas, test_system, grid, partition1, 1, sigma1);
        CalculateCoefficientsS(e_coeff2, f_coeff2, b_coeff_vec_shift2, b_coeff_vec2, lr_sol, blas, test_system, grid, partition1, 2, sigma1);
        CalculateCoefficientsS(e_coeff3, f_coeff3, b_coeff_vec_shift3, b_coeff_vec3, lr_sol, blas, test_system, grid, partition1, 3, sigma1);
    ...
    // {
        ...
        PerformSStep(sigma1, sigma2, lr_sol, blas, test_system, grid, partition1, partition2, w_x_dep, tau);
